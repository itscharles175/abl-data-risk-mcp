...
- trusted production writers for modern SQL capture and certification evidence; the legacy ingestion path lacks the frozen source-contract/extraction, active mapping-execution, runtime/dictionary-bundle, and exact-population evidence required to create these records soundly;
